...
//			res.sendRedirect(url + req.getContextPath() + "/login");
	...
	public void redirectPage(@BindingParam("zul") String zul, @BindingParam("vmArgs") Object vmArgs,
			@BindingParam("vm") Object vm, @BindingParam("nhom") Object nhom,  @BindingParam("dvc") Object dvc, @BindingParam("ds") Object ds,
			@BindingParam("dsHLV") Object dsHLV) {

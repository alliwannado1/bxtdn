...
public class VaiTro extends Model<VaiTro> {
	...
	public Set<String> getQuyenAllMacDinhs() {
		...
		quyens1.add(core().PHONGBANTHEM);
		quyens1.add(core().PHONGBANSUA);
		quyens1.add(core().PHONGBANXEM);
		quyens1.add(core().PHONGBANLIST);
		quyens1.add(core().PHONGBANXOA);

		quyens1.add(core().CHUCDANHTHEM);
		quyens1.add(core().CHUCDANHSUA);
		quyens1.add(core().CHUCDANHXEM);
		quyens1.add(core().CHUCDANHLIST);
		quyens1.add(core().CHUCDANHXOA);

		quyens1.add(core().CAPDONVIHANHCHINHTHEM);
		quyens1.add(core().CAPDONVIHANHCHINHSUA);
		quyens1.add(core().CAPDONVIHANHCHINHXEM);
		quyens1.add(core().CAPDONVIHANHCHINHLIST);
		quyens1.add(core().CAPDONVIHANHCHINHXOA);
		...
		quyens1.add(core().THONGBAOCHUNGLIST);
		quyens1.add(core().THONGBAOCHUNGXEM);

		quyens1.add(core().CAUHINHHETHONGLIST);
		quyens1.add(core().CAUHINHHETHONGSUA);
